  ...
  <div :class="['list-item', showState, selectMessages]">
    <div class="row" dusk="hover">
      ...
      <div class="col-md-2">
        <div>
          <ul class="iconos-uno">
            ...
            <li dusk="btn-starred" @click="updateMessage('starred')" class="icono">
              <svg dusk="unCheck" :class="['unCheck-' + showStarred]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path
              ...
              <svg dusk="check" :class="['check-' + showStarred]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path
      ...
      <div class="col-md-2">
        ...
        <div class="iconos">
          <ul>
            <li dusk="btn-state" @click="updateMessage('readOrUnread')">
              <svg :class="['read-' + showState]" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                viewBox="0 0 24 24">
                <path
              ...
              <svg :class="['unread-' + showState]" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                viewBox="0 0 24 24">
                <path
